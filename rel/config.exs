...
#  set cookie: :"X:$`I2chm9V:HxQ>RM~/Ao0)TP:j]Y|*Pb58KPZ8;|Hgyq%e}Q(Dld4:YMa3T30l"
#end

environment :prod do
  set include_erts: true
  set include_src: false
  #set cookie: :"YIpUY9y:_bKWe=b|=MwD]$)1B0@kO/=a.r}4BS^kl2<KYfKme:K1SGc_GqWf5mvM"
...
release :kukotbot do
  set version: current_version(:kukotbot)
  set applications: [
    :runtime_tools
  ]
